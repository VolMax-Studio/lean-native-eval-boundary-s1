...
The signature was selected after exposure to reference source at f3b06c705e6c85f5314019d5d3baab0fec5b580c, mapped by the saved snapshot to denominator member v4.32.2 (resolved to commit object f3b06c705e6c85f5314019d5d3baab0fec5b580c in TAG_MANIFEST.json; all 45 denominator tags are resolved commit objects). This member is a development reference, not outcome-blind. The designated Gate reports a pre-freeze positive-control source-proxy run on this member yielding MISMATCH. It remains prior exposure, not a prospectively measured holdout. No full-denominator scan has been performed in this task.
